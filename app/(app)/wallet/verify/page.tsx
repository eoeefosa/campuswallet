...
export default function VerifyPage({
  ...
  useEffect(() => {
    ...
    api
      .get<VerifyResult>(`/api/payments/verify/${reference}`)
      .then(setResult)
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center">
        ...
        <Link href="/wallet" className="bg-green-600 text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-green-700">
          Back to Wallet
        </Link>
      </div>
    )
